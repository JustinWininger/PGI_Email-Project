...
emailsMF %>%
  ggplot( aes(x=Day, y=`Open Rate`, fill=Day)) +
    ...
    geom_boxplot(width=0.1, alpha=0.2, color = '#9EA032') +
  ...
  geom_text(data = countsMF,
            aes(Day, Inf, label = n), vjust = 1)+
  scale_fill_manual(values = c('#173C58', '#4091B0', '#173C58', '#4091B0', '#173C58'))
...
emailsMF %>%
  ...
  geom_boxplot(color = '#9EA032', fill = c('#173C58', '#4091B0', '#173C58', '#4091B0', '#173C58', '#173C58', '#4091B0', '#173C58', '#4091B0', '#173C58'))+
  theme_ipsum() +
    theme(
      legend.position="none",
      plot.title = element_text(size=11),
