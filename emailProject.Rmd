...
punctuation <- emails %>%
  ...
  summarise(
    ...
    CTORate=round(median(CTOR), digits =2),
...
| Size  | Count | Median List Size | Median Open Rate | Median Click to Open Rate | Median Bounce Rate |
|:----------:|:----------:|:----------:|:----------:|:----------:|:----------:|
|  All  |  59   |       1403       |      33.27%      |           3.09%           |       4.73%        |
| Large |  27   |       4219       |      33.28%      |           2.56%           |       3.88%        |
| Small |  32   |       838        |      32.99%      |           3.98%           |       4.98%        |
...
| Duplicate | Count | Median Open Rate | Median Click to Open Rate | Median Bounce Rate |
|:------------:|:------------:|:------------:|:-------------:|:-------------:|
...
dupes <- emails %>% 
  ...
  summarise(
    ...
    CTORate=round(median(CTOR), digits =4),
...
|          Product Type           | Count | Median Open Rate | Median Click to Open Rate | Median Bounce Rate |
|:-------------:|:-------------:|:-------------:|:-------------:|:-------------:|
| Professional Advisor newsletter |  149  |      29.02%      |          23.08%           |       5.50%        |
|           All Others            |  461  |      36.13%      |           2.15%           |       4.27%        |

These results seem incredibly different, and a Chi-Squared test confirms it. Professional Advisor Newsletters are statistically significantly different from all other product types. They have a significantly lower open rate, but a significantly higher click rate. The bounce rate is higher, but not significantly.
